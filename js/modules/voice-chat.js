...
// ===================================================
// 🚫 TEMPORARILY DISABLED FOR MOBILE COMPATIBILITY
// Google blocks overlay popups on mobile devices
// ===================================================
...
function loadInterviewInterface() {
    // Instead of popup, add interview message to chat
    addAIMessage("🚀 Great! I'll connect you with Bruce Clark for a detailed interview about your practice. He'll reach out to you soon with next steps!");
    
    // Update smart button to show completion
    updateSmartButton(false, '', '');
    
    console.log("Interview request logged - Bruce will follow up");
}
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  requestMicrophoneAccess(); // Request mic permission immediately
});
