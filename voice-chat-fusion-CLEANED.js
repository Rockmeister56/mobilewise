...
// ===================================================
// 🧠 AI RESPONSE SYSTEM - OPTIMIZED VERSION
// ===================================================
function getAIResponse(userInput) {
    ...
    // 🎯 EMAIL FOLLOW-UP HANDLER CHECK - DO THIS FIRST
    ...
    if (responseText && (responseText.includes('click') || responseText.includes('button above'))) {
        window.lastClickMentionTime = Date.now();
        console.log('⏰ Click mention detected - setting blocking window');
    }
...
function showHybridReadySequence() {
    ...
    banner.id = 'speak-sequence-button';
    banner.className = 'quick-btn mobile-wise-banner speak-now-state';
    ...
    // Add to container or fallback to body
    if (container) {
    ...
    console.log('🎨 Speak Now banner created');
    ...
    const directTimer = setTimeout(() => {
        ...
        console.log('⏰ DIRECT: 7-second listening window ended - no speech detected');
