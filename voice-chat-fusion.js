...
avatar: {
   content: `
        <div class="banner-glow-container" style="width: 820px; max-width: 820px; margin: 0 auto; height: 80px; display: flex; justify-content: center; align-items: center; padding: 0 20px; border-radius: 8px; background: linear-gradient(135deg, #000d28ff, #000000ff); box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
