...
class KnowledgeBaseLoader {
    ...
    async loadKnowledgeBases(industryName = null, clientName = null) {
        try {
            ...
            const industryResponse = await fetch(`/knowledge-base/knowledge-bases/${industry}.json`);
            ...
            const clientResponse = await fetch(`/knowledge-base/client-specific/${client}.json`);
