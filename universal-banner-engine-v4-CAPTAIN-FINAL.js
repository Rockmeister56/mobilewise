...
(function() {
    ...
    clickToCall: {
        content: `
            <div class="banner-glow-container banner-cta-full" style="width: 780px; max-width: 780px; margin: 0 auto; height: 90px; display: flex; justify-content: center; align-items: center; padding: 0 20px; border-radius: 8px; background: linear-gradient(135deg, #0f5ef0ff 0%, #000000ff 100%); box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
                <div style="display: flex; align-items: center;">
